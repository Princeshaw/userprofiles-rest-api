...
class HelloViewSet(viewsets.ViewSet):
    ...
    def list(self,request):
        ...
        a_viewset = ['Uses HTTP methods as function(get,post,patch,put,delete)','Is similar to traditional Django View',
                      'gives you the most control over you application logic','Is mapped manually to urls',]
    ...
    def retrieve(self,request,pk=None):
        """Handled getting an object by its ID"""
